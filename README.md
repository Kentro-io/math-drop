...
🎮 **[Play now](https://kentro-io.github.io/brainspark)** — works on any device, no install needed.
...
BrainSpark is a growing collection of mini-games that train exactly that. Each game targets a different aspect of problem solving — mental math, pattern recognition, logic, memory, estimation. They feel like games, not homework. And they build the kind of thinking that no AI can do for you.
...
|-------|------|----------------|
| 🌱 Pre-K | 3-5 | Counting, simple addition |
| 🌿 Kindergarten | 5-6 | Addition & subtraction to 10 |
| 🌳 1st Grade | 6-7 | Addition & subtraction to 20 |
| 🪴 2nd Grade | 7-8 | Two-digit problems, intro to multiplication |
| 🌲 3rd Grade | 8-9 | Multiplication & division |
...
Math Drop is just the beginning. BrainSpark is designed to become a full arcade of brain-building mini-games, and we need help making that happen.
...
No `npm install`. No build. No environment variables. Just HTML.
...
<p align="center">
  ...
  <sub>We build operations software for e-commerce. BrainSpark is our way of giving back.</sub>
</p>
